...
if ($_REQUEST['act'] == 'load_more_goods') {
	...
	$cart = array('user_id' => $user_id, 'session_id' => $sess, 'goods_id' => $auction['goods_id'], 'product_id' => isset($products['product_id']) ? $products['product_id'] : 0, 'goods_sn' => addslashes($goods['goods_sn']), 'goods_name' => addslashes($goods['goods_name']), 'market_price' => $goods['market_price'], 'goods_price' => $auction['last_bid']['bid_price'], 'goods_number' => 1, 'goods_attr' => addslashes($goods_attr), 'goods_attr_id' => $goods_attr_id, 'warehouse_id' => $region_id, 'area_id' => $area_id, 'area_city' => $area_city, 'is_real' => $goods['is_real'], 'ru_id' => $goods['user_id'], 'extension_code' => addslashes($goods['extension_code']), 'parent_id' => 0, 'rec_type' => CART_AUCTION_GOODS, 'is_gift' => 0);
