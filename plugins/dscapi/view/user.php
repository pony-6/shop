...
$rank_name = isset($_REQUEST['rank_name']) ? $base->get_addslashes($_REQUEST['rank_name']) : -1;
$address_id = isset($_REQUEST['address_id']) ? $base->get_intval($_REQUEST['address_id']) : -1;
$val = array('user_id' => $user_id, 'user_name' => $user_name, 'mobile' => $mobile, 'rank_id' => $rank_id, 'rank_name' => $rank_name, 'address_id' => $address_id, 'user_select' => $data, 'page_size' => $page_size, 'page' => $page, 'sort_by' => $sort_by, 'sort_order' => $sort_order, 'format' => $format);
