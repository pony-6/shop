...
$is_delete = isset($_REQUEST['is_delete']) ? $base->get_intval($_REQUEST['is_delete']) : -1;
...
$val = array('seller_type' => $seller_type, 'seller_id' => $seller_id, 'brand_id' => $brand_id, 'cat_id' => $cat_id, 'user_cat' => $user_cat, 'goods_id' => $goods_id, 'goods_sn' => $goods_sn, 'bar_code' => $bar_code, 'is_delete' => $is_delete, 'w_id' => $w_id, 'a_id' => $a_id, 'region_id' => $region_id, 'region_sn' => $region_sn, 'img_id' => $img_id, 'attr_id' => $attr_id, 'goods_attr_id' => $goods_attr_id, 'tid' => $tid, 'goods_select' => $data, 'page_size' => $page_size, 'page' => $page, 'sort_by' => $sort_by, 'sort_order' => $sort_order, 'format' => $format);
