...
class common
{
	...
	static public function common($data = array())
	{
		...
		self::$info = isset($data['info']) ? $data['info'] : array();
	}
	...
	static private function get_shipping_info($code)
	{
		...
		$control_table = array(
			...
			array('cloud_code' => 'WXWL', 'name' => '万象物流', 'code' => ''),
			array('cloud_code' => 'CHINAPOST', 'name' => '邮政包裹', 'code' => ''),
			array('cloud_code' => 'AuExpress', 'name' => '澳邮中国', 'code' => ''),
			array('cloud_code' => 'sure', 'name' => '速尔快递', 'code' => '')
			);
