            ...
            <!-- 图片 -->
            <div class="visual-item" data-purebox="CMS" data-mode="CMS_ADV">
                ...
                <div class="view" data-type="range">
                    <div class="banner-article">
                    	<div class="banner-main">
                        	<div class="bd">
                            	<ul>
                                	<li><a href="#" target="_blank"><img src="images/article-index/bb.jpg" alt=""><p>受邀参加中国国际软件和信息服务</p></a></li>
                                </ul>
                            </div>
                            <div class="hd"><ul></ul></div>
                        </div>
                        <div class="banner-second">
                        	<div class="s mb10"><a href="#" target="_blank"><img src="images/article-index/bs.jpg" alt=""><p>受邀参加中国国际软件和信息服务</p></a></div>
                        	<div class="s"><a href="#" target="_blank"><img src="images/article-index/bs_1.jpg" alt=""><p>受邀参加中国国际软件和信息服务</p></a></div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- 两列 -->
            <div class="visual-item" data-purebox="CMS_ARTI" data-mode="CMS_TWO_LIE">
                ...
                <div class="view" data-type="range">
                    <div class="article-col-2 clearfix">
                        <div class="article-box">
                            ...
                            <div class="ab-bd">
                                <div class="focus">
                                    <a href="http://about.ecmoban.com/article-7760.html" target="_blank" class="img"><img src="images/article-index/col2.jpg" alt=""></a>
                                    <div class="info">
                        ...
                        <div class="article-box">
                            ...
                            <div class="ab-bd">
                                <div class="focus">
                                    <a href="#" target="_blank" class="img"><img src="images/article-index/col1.jpg" alt=""></a>
                                    <div class="info">
            ...
            <!-- 近期热门 精品推荐 -->
            <div class="visual-item" data-purebox="CMS_HEAT_LIE" data-mode="CMS_HEAT_LIE">
                ...
                <div class="view" data-type="range">
                    <div class="article-col-1-2 clearfix">
                        ...
                        <div class="article-box">
                            <div class="ab-hd"><h2><i class="iconfont icon-article"></i>精品推荐</h2></div>
                            <div class="ab-bd">
                                <ul class="g-list clearfix">
                                    <li>
                                        <a href="#" target="_blank">
                                            <img src="images/article-index/test_002.jpg" alt="">
                                            <p>苏泊尔（SUPOR)电压</p>
                                        </a>
                                    </li>
                                    <li>
