...
if ($_REQUEST['act'] == '') {
	...
	$sql = 'SELECT COUNT(*) FROM ' . $ecs->table('store_order') . ' as o, ' . $GLOBALS['ecs']->table('order_info') . ' AS oi1 ' . ' WHERE (o.store_id = \'' . $store_id . '\' OR (o.store_id = \'0\' AND o.is_grab_order = \'1\' AND FIND_IN_SET(\'' . $store_id . '\',grab_store_list)))' . $where . ' AND oi1.order_id = o.order_id';
