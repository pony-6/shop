...
?>
        <li style="background:url(<?php echo $this->_var['ad']['ad_code']; ?>) center center no-repeat;"><div class="banner-width"><a href="<?php echo empty($this->_var['ad']['ad_link']) ? '#' : $this->_var['ad']['ad_link']; ?>" target="_blank"></a></div></li>
