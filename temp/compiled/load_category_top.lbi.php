...
<div class="catetop-floor" id="floor_<?php echo $this->_var['rome_number']; ?>" ectype="floorItem">
	<div class="f-hd">
		...
		<div class="extra">
			<div class="fgoods-hd">
				<ul>
					<?php $_from = $this->_var['one_cate_child']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child_0_16076000_1611048251');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['child_0_16076000_1611048251']):
        $this->_foreach['no']['iteration']++;
?>
					<?php if ($this->_foreach['no']['iteration'] < 6): ?>
					<li <?php if ($this->_foreach['no']['iteration'] == 1): ?> class="on"<?php endif; ?>><?php echo htmlspecialchars($this->_var['child_0_16076000_1611048251']['name']); ?></li>
					<?php endif; ?>
	...
	<div class="f-bd clearfix">
		...
		<div class="bd-right">
			...
			<div class="right-bottom">
				<?php $_from = $this->_var['one_cate_child']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child_0_16082700_1611048251');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['child_0_16082700_1611048251']):
        $this->_foreach['no']['iteration']++;
?>
				<?php if ($this->_foreach['no']['iteration'] < 6): ?>
				<ul class="fgoods-list">
					<?php $_from = $this->_var['child_0_16082700_1611048251']['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
...
<div class="catetop-floor" id="floor_<?php echo $this->_var['rome_number']; ?>" ectype="floorItem">
    <div class="f-hd">
        ...
        <div class="extra">
            <div class="fgoods-hd">
                <ul>
                    <?php $_from = $this->_var['one_cate_child']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child_0_16099200_1611048251');$this->_foreach['child'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['child']['total'] > 0):
    foreach ($_from AS $this->_var['child_0_16099200_1611048251']):
        $this->_foreach['child']['iteration']++;
?>
                    <?php if (($this->_foreach['child']['iteration'] - 1) < 5): ?>
                    <li<?php if ($this->_foreach['child']['iteration'] == 1): ?> class="on"<?php endif; ?>><?php echo $this->_var['child_0_16099200_1611048251']['name']; ?></li>
                    <?php endif; ?>
                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </ul>
            </div>
    ...
    <div class="f-bd">
        <div class="bd-left">
            ...
            <div class="l-menu">
                <?php $_from = $this->_var['one_cate_child']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child_0_16104200_1611048251');$this->_foreach['child'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['child']['total'] > 0):
    foreach ($_from AS $this->_var['child_0_16104200_1611048251']):
        $this->_foreach['child']['iteration']++;
?>
                    <?php if (($this->_foreach['child']['iteration'] - 1) < 6): ?>
                    <a href="<?php echo $this->_var['child_0_16104200_1611048251']['url']; ?>" target="_blank"><?php echo $this->_var['child_0_16104200_1611048251']['name']; ?></a>
                    <?php endif; ?>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </div>
        </div>
        <div class="bd-right">
            <?php $_from = $this->_var['one_cate_child']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child_0_16107900_1611048251');$this->_foreach['child'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['child']['total'] > 0):
    foreach ($_from AS $this->_var['child_0_16107900_1611048251']):
        $this->_foreach['child']['iteration']++;
?>
            <?php if (($this->_foreach['child']['iteration'] - 1) < 5): ?>
            <ul class="fgoods-list"<?php if (($this->_foreach['child']['iteration'] <= 1)): ?> style="display:block;"<?php else: ?> style="display:none;"<?php endif; ?>>
                <?php $_from = $this->_var['child_0_16107900_1611048251']['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
...
<div class="catetop-floor" id="floor_<?php echo $this->_var['rome_number']; ?>" ectype="floorItem">
    <div class="f-hd">
        ...
        <div class="extra">
            <div class="fgoods-hd">
                <ul>
                <?php $_from = $this->_var['one_cate_child']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child_0_16133900_1611048251');$this->_foreach['child'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['child']['total'] > 0):
    foreach ($_from AS $this->_var['child_0_16133900_1611048251']):
        $this->_foreach['child']['iteration']++;
?>
                    <?php if (($this->_foreach['child']['iteration'] - 1) < 5): ?>
                    <li><?php echo $this->_var['child_0_16133900_1611048251']['name']; ?></li>
                    <?php endif; ?>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </ul>
            </div>
    ...
    <div class="f-bd">
        ...
        <div class="bd-right">
        <?php $_from = $this->_var['one_cate_child']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child_0_16137500_1611048251');$this->_foreach['child'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['child']['total'] > 0):
    foreach ($_from AS $this->_var['child_0_16137500_1611048251']):
        $this->_foreach['child']['iteration']++;
?>
        <?php if (($this->_foreach['child']['iteration'] - 1) < 5): ?>
            <ul class="fgoods-list" <?php if ($this->_foreach['child']['iteration'] > 1): ?> style="display:none;" <?php endif; ?>>
                <?php $_from = $this->_var['child_0_16137500_1611048251']['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods']):
        $this->_foreach['goods']['iteration']++;
?>
                ...
                <li>
                    ...
                    <a href="<?php echo $this->_var['goods']['url']; ?>" class="p-btn" target="_blank"><i class="iconfont icon-cart"></i><?php echo $this->_var['lang']['button_buy']; ?></a>
                </li>
                <?php endif; ?>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </ul>
