                    ...
                    <div class="s-l-value brand_select_more">
                        <div class="all_a_z">
                            <ul class="a_z">
                                ...
                                <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'letter_0_65098900_1611048245');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['letter_0_65098900_1611048245']):
?>
                                <li data-key="<?php echo $this->_var['letter_0_65098900_1611048245']; ?>"><?php echo $this->_var['letter_0_65098900_1611048245']; ?></li>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
            ...
            <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_65123000_1611048245');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_65123000_1611048245']):
?>
            <li class="s-line same_li">
            	<dl class="s-l-wrap attr_list">
                    <div class="s-l-tit filter_attr_name"><?php echo htmlspecialchars($this->_var['filter_attr_0_65123000_1611048245']['filter_attr_name']); ?>：</div>
                    <div class="s-l-value attr_son">
                        <div class="item_list">
                            <?php $_from = $this->_var['filter_attr_0_65123000_1611048245']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
