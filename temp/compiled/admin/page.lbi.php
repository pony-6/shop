...
<div id="turn-page">
    ...
    <span class="page mr10"><i><?php echo $this->_var['lang']['to']; ?></i><input type="text" size="3" value="<?php echo $this->_var['filter']['page']; ?>" onkeyup="listTable.gotoPage($(this).val())"></span>
    <span id="page-link">
