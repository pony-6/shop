    	...
    	<div class="w w1200">
            ...
            <div class="contact">
                ...
                <div class="contact-item">
                    ...
                    <a id="IM" IM_type="dsc" onclick="openWin(this)" href="javascript:;" class="btn-ctn"><i class="f-icon f-icon-kefu"></i><span><?php echo $this->_var['lang']['consulting_service']; ?></span></a>
                    <?php else: ?>
                        <?php if ($this->_var['basic_info']['kf_type'] == 1): ?>
                        <a href="http://www.taobao.com/webww/ww.php?ver=3&touid=<?php echo $this->_var['basic_info']['kf_ww']; ?>&siteid=cntaobao&status=1&charset=utf-8" class="btn-ctn" target="_blank"><i class="f-icon f-icon-kefu"></i><span><?php echo $this->_var['lang']['consulting_service']; ?></span></a>
                        <?php else: ?>
                        <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $this->_var['basic_info']['kf_qq']; ?>&site=qq&menu=yes" class="btn-ctn" target="_blank"><i class="f-icon f-icon-kefu"></i><span><?php echo $this->_var['lang']['consulting_service']; ?></span></a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <div class="footer-new-bot">
    	<div class="w w1200">
            ...
            <p class="copyright_links">
                <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_59779100_1611044290');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_59779100_1611044290']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
                <a href="<?php echo $this->_var['nav_0_59779100_1611044290']['url']; ?>"<?php if ($this->_var['nav_0_59779100_1611044290']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_59779100_1611044290']['name']; ?></a>
...
?>
            ...
            <p><span>©&nbsp;2015-2018&nbsp;dscmall.cn&nbsp;版权所有&nbsp;&nbsp;</span><span><?php echo $this->_var['lang']['icp_number']; ?>:</span><a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo $this->_var['icp_number']; ?></a>&nbsp;POWERED by<a href="http://www.xsuishen.com/" target="_blank">随身团</a>2.0</p>
            <?php endif; ?>
