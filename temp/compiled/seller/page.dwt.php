...
<div id="turn-page">
    <div class="pagination">
        <ul>
            ...
            <?php $_from = $this->_var['page_count_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'page_count_0_63667600_1611045290');$this->_foreach['pageCount'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['pageCount']['total'] > 0):
    foreach ($_from AS $this->_var['page_count_0_63667600_1611045290']):
        $this->_foreach['pageCount']['iteration']++;
?>
            <?php if ($this->_var['page_count_0_63667600_1611045290'] == $this->_var['filter']['page']): ?>
                <li><span class="currentpage"><?php echo $this->_var['page_count_0_63667600_1611045290']; ?></span></li>
            <?php else: ?>
                <li><a href="javascript:listTable.gotoPage(<?php echo $this->_var['page_count_0_63667600_1611045290']; ?>)"><span><?php echo $this->_var['page_count_0_63667600_1611045290']; ?></span></a></li>
            <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <!-- <input type="text" name="" value="<?php echo $this->_var['filter']['page']; ?>" class="text text40" onblur="listTable.gotoPage($(this).val())"></a> -->
