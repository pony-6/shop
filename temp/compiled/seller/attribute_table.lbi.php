...
?>
            ...
            <th width="10%" <?php if ($this->_var['goods_attr_price'] == 0 || $this->_var['add_shop_price'] == 1): ?>class="hide"<?php endif; ?>><em class="require-field">*</em><?php echo $this->_var['lang']['price_market']; ?><i class="sc_icon sc_icon_edit pointer pro_market"></i></th>
            <th width="10%" <?php if ($this->_var['goods_attr_price'] == 0): ?>class="hide"<?php endif; ?>><em class="require-field pointer">*</em><?php echo $this->_var['lang']['price_shop']; ?><i class="sc_icon sc_icon_edit pointer pro_shop"></i></th>
            <th width="10%" <?php if ($this->_var['goods_attr_price'] == 0 || $this->_var['add_shop_price'] == 1): ?>class="hide"<?php endif; ?>><em class="require-field pointer">*</em><?php echo $this->_var['lang']['price_promotion']; ?><i class="sc_icon sc_icon_edit pointer pro_promote"></i></th>
            <th width="10%"><em class="require-field">*</em><?php echo $this->_var['lang']['storage']; ?><i class="sc_icon sc_icon_edit pointer pro_number pointer"></i></th>
            <th width="10%"><em class="require-field">*</em><?php echo $this->_var['lang']['warning_value']; ?><i class="sc_icon sc_icon_edit pointer pro_warning pointer"></i></th>
...
?>
                <tr data-changelog="<?php echo $this->_var['group']['changelog']; ?>">
                    <td class="td_bg_blue" style="padding:0px 5px;" <?php if ($this->_var['add_shop_price'] == 1): ?>width="20%"<?php endif; ?>>
...
?><?php echo $this->_var['one']['attr_value']; ?>
                    ...
                    <td width="10%"><input type="text" name="product_number[]" onBlur="listTable.editInput(this, 'edit_product_number', <?php echo empty($this->_var['group']['product_id']) ? '0' : $this->_var['group']['product_id']; ?>, $('#goods_model').val(), 'goods_model');" class="text w50 tc" autocomplete="off" value="<?php echo empty($this->_var['group']['product_number']) ? '0' : $this->_var['group']['product_number']; ?>" /></td>
                    <td width="10%"><input type="text" name="product_warn_number[]" onBlur="listTable.editInput(this, 'edit_product_warn_number', <?php echo empty($this->_var['group']['product_id']) ? '0' : $this->_var['group']['product_id']; ?>, $('#goods_model').val(), 'goods_model');" class="text w50 tc" autocomplete="off" value="<?php echo empty($this->_var['group']['product_warn_number']) ? '1' : $this->_var['group']['product_warn_number']; ?>" /></td>
                    <td width="12%"><input type="text" name="product_sn[]" onBlur="listTable.editInput(this, 'edit_product_sn', <?php echo empty($this->_var['group']['product_id']) ? '0' : $this->_var['group']['product_id']; ?>, $('#goods_model').val(), 'goods_model');" class="text w90" autocomplete="off" value="<?php echo $this->_var['group']['product_sn']; ?>" /></td>
                    <td width="12%"><input type="text" name="product_bar_code[]" onBlur="listTable.editInput(this, 'edit_product_bar_code', <?php echo empty($this->_var['group']['product_id']) ? '0' : $this->_var['group']['product_id']; ?>, $('#goods_model').val(), 'goods_model');" class="text w90" autocomplete="off" value="<?php echo $this->_var['group']['bar_code']; ?>" /></td>
                    <td width="5%">
                        <?php if ($this->_var['group']['product_id'] && $this->_var['group']['changelog'] == 0): ?>
                            <a href="javascript:void(0);" class="blue" onclick="if (confirm('<?php echo $this->_var['lang']['trash_product_confirm']; ?>')) dropProduct('<?php echo $this->_var['group']['product_id']; ?>')"><?php echo $this->_var['lang']['drop']; ?></a>
                        <?php else: ?>
    ...
    <div id="turn-page" class="attr-turn-page">
        <div class="pagination">
            <ul>
                <li style=" padding:0px 3px;"><?php if ($this->_var['filter']['page'] != 1): ?><a href="javascript:listTable.gotoPageFirst()"><?php endif; ?><span><?php echo $this->_var['lang']['00_home']; ?></span><?php if ($this->_var['filter']['page'] != 1): ?></a><?php endif; ?></li>
...
?>
    ...
    <div class="goods_attr_04_batch" style="padding:0px;">
        <?php if ($this->_var['goods_model'] == 1): ?>
            <a href="javascript:;" class="sc-btn btn35 sc-redBg-btn" id="produts_warehouse_batch"><?php echo $this->_var['lang']['batch_upload_csv']; ?></a>
        <?php elseif ($this->_var['goods_model'] == 2): ?>
            <a href="javascript:;" class="sc-btn btn35 sc-redBg-btn" id="produts_area_batch"><?php echo $this->_var['lang']['batch_upload_csv']; ?></a>
        <?php else: ?>
            <a href="javascript:;" class="sc-btn btn35 sc-redBg-btn" id="produts_batch"><?php echo $this->_var['lang']['batch_upload_csv']; ?></a>
        <?php endif; ?>
        <a href="javascript:;" class="sc-btn btn35 sc-redBg-btn" id="attr_refresh"><?php echo $this->_var['lang']['refresh']; ?></a>
    </div>    
