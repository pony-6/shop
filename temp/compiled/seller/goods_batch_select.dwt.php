                            ...
                            <div id="cat_batch">
                                <dl class="notBg border-bottom0">
                                     <div class="goods_search_div pt10">
                                        ...
                                        <input type="text" name="keyword" class="text text_2 mr10" value="" placeholder="<?php echo $this->_var['lang']['input_keywords']; ?>" data-filter="keyword" autocomplete="off" />
                                        <a href="javascript:void(0);" class="sc-btn sc-blueBg-btn" ectype="search"><?php echo $this->_var['lang']['button_search']; ?></a>
                                    </div>
                                </dl>
                                    ...
                                    <div class="move_div mt0">
                                        <div class="move_left">
                                            ...
                                            <div class="move_handle">
                                                ...
                                                <a href="javascript:void(0);" class="sc-btn btn25 sc-blueBg-btn" ectype="sub" data-operation="add_edit_goods"><?php echo $this->_var['lang']['button_submit_alt']; ?></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="move_right">
                                            ...
                                            <div class="move_handle">
                                                <a href="javascript:void(0);" class="sc-btn btn25 moveAll" ectype="moveAll"><?php echo $this->_var['lang']['check_all']; ?></a>
                                                <a href="javascript:void(0);" class="sc-btn btn25 sc-blueBg-btn" ectype="sub" data-operation="drop_edit_goods"><?php echo $this->_var['lang']['remove']; ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </dl>
                            ...
                            <div id="sn_batch" style="display:none">
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        <div class="notic"><?php echo $this->_var['lang']['one_row_one']; ?></div>
                                    </dd>
                                </dl>
                            </div>
                            <dl class="notBg">
