...
?>
        <td>
            <input type="text" name="volume_number[]" value="<?php echo $this->_var['volume_price']['number']; ?>" class="text w50 td_num" autocomplete="off" />
...
if ($this->_foreach['volume_price_tab']['total'] > 0):
    foreach ($_from AS $this->_var['volume_price']):
        $this->_foreach['volume_price_tab']['iteration']++;
?>
        <td><a href="javascript:;" class="sc-btn btn25 sc-blueBg-btn" data-id="<?php echo $this->_var['volume_price']['id']; ?>" ectype="remove_volume"><?php echo $this->_var['lang']['drop']; ?></a></td>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		<?php if (! $this->_var['volume_price_list']): ?>
        <td><a href="javascript:;" class="sc-btn btn25 sc-blueBg-btn" data-id="0" ectype="remove_volume"><?php echo $this->_var['lang']['drop']; ?></a></td>
		<?php endif; ?>
    </tr>
</table>