...
?>
    ...
    foreach ($_from AS $this->_var['con']):
?>
        <td><a href="javascript:;" class="sc-btn btn25 sc-blueBg-btn" data-id="<?php echo $this->_var['con']['id']; ?>" ectype="remove_cfull"><?php echo $this->_var['lang']['drop']; ?></a></td>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        <td><a href="javascript:;" class="sc-btn btn25 sc-blueBg-btn" data-id="0" ectype="remove_cfull"><?php echo $this->_var['lang']['drop']; ?></a></td>
    </tr>
</table>