...
<div class="ecsc-form-title mb20">
    <i class="dian"></i>
    <h3><?php echo $this->_var['lang']['attr_pic']; ?></h3>
    <?php if ($this->_var['goods_attr_price'] == 0): ?>
        <?php if ($this->_var['goods_model'] == 1): ?>
        	<a href="goods_warehouse_attr_batch.php?act=add&goods_id=<?php echo $this->_var['goods_id']; ?>" class="sc-btn btn35 sc-redBg-btn ml30" target="_blank"><?php echo $this->_var['lang']['batch_upload_csv']; ?></a>
        <?php elseif ($this->_var['goods_model'] == 2): ?>
        	<a href="goods_area_attr_batch.php?act=add&goods_id=<?php echo $this->_var['goods_id']; ?>" class="sc-btn btn35 sc-redBg-btn ml30" target="_blank"><?php echo $this->_var['lang']['batch_upload_csv']; ?></a>
        <?php endif; ?>
    <?php endif; ?>
</div>
...
?>
	<!--处理属性图片 start-->
    <div class="attr_item">
        <div class="txt text_readonly" title="<?php echo $this->_var['val']['attr_value']; ?>" data-toggle="tooltip"><?php echo $this->_var['val']['attr_value']; ?></div>
        <div class="info <?php if ($this->_var['goods_attr_price'] != 0): ?><?php if ($this->_var['val']['attr_type'] == 1): ?>hide<?php endif; ?><?php endif; ?>">
            <?php if ($this->_var['goods_model'] == 1): ?>
            <input name="warehouse_butt" class="sc-btn btn30 sc-blueBg-btn mr10 <?php if ($this->_var['goods_attr_price'] != 0): ?><?php if ($this->_var['val']['attr_type'] == 1): ?>hide<?php endif; ?><?php endif; ?>" value="<?php echo $this->_var['lang']['warehouse_price']; ?>" type="button" data-goodsattrid="<?php echo $this->_var['val']['goods_attr_id']; ?>">  
            <?php elseif ($this->_var['goods_model'] == 2): ?>
            <input name="area_butt" class="sc-btn btn30 sc-blueBg-btn mr10 <?php if ($this->_var['goods_attr_price'] != 0): ?><?php if ($this->_var['val']['attr_type'] == 1): ?>hide<?php endif; ?><?php endif; ?>" value="<?php echo $this->_var['lang']['area_price']; ?>" type="button" data-goodsattrid="<?php echo $this->_var['val']['goods_attr_id']; ?>">
            <?php else: ?>
        ...
        <div class="info">
            <label><?php echo $this->_var['lang']['sort_order']; ?></label>
            <input type="text" class="text w40 tc" name="gallery_attr_sort[]" onBlur="listTable.editInput(this, 'edit_attr_sort', <?php echo empty($this->_var['val']['goods_attr_id']) ? '0' : $this->_var['val']['goods_attr_id']; ?>);" size="10" value="<?php echo $this->_var['val']['attr_sort']; ?>" />
        </div>
        
        <?php if (($this->_foreach['onspec']['iteration'] <= 1) && $this->_var['val']['goods_attr_id']): ?>
        <a href="javascript:;" ectype="add_attr_img" class="up_img" data-goodsattrid="<?php echo empty($this->_var['val']['goods_attr_id']) ? '0' : $this->_var['val']['goods_attr_id']; ?>" data-attrid="<?php echo empty($this->_var['val']['attr_id']) ? '0' : $this->_var['val']['attr_id']; ?>"><?php echo $this->_var['lang']['upload_image']; ?></a>
		<?php endif; ?>
