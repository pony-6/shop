		...
		<div class="ecsc-layout-right">
            <div class="main-content" id="mainContent">
				...
				<div class="ecsc-form-goods">
                    ...
                    <form action="goods_area_attr_batch.php?act=upload" method="post" enctype="multipart/form-data" name="theForm" id="goods_area_attr_batch_form">
                        <div class="wrapper-list border1 mt20">
                            <?php if ($this->_var['goods_name']): ?>
                            <dl>
                                <dt><?php echo $this->_var['lang']['goods_name']; ?></dt>
                                <dd><?php echo $this->_var['goods_name']; ?></dd>
                            </dl>
                            <?php endif; ?>
                            <dl>
...
?>
                            ...
                            <dl>
                                <dt>&nbsp;</dt>
                                <dd class="lh"><a href="goods_area_attr_batch.php?act=download&charset=<?php echo $this->_var['charset']; ?>&goods_id=<?php echo $this->_var['goods_id']; ?>&attr_name=<?php echo $this->_var['attr_name']; ?>" class="blue"><?php echo $this->_var['download']; ?></a></dd>
                            </dl>
                            <?php endif; ?>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            <dl class="button_info">
                                <dt>&nbsp;</dt>
                                <dd><input name="submit" type="submit" id="submit" value="<?php echo $this->_var['lang']['button_submit']; ?>" class="sc-btn sc-blueBg-btn btn35" /></dd>
                            </dl>
                        </div>
                    </form>
				</div>
