<div class="select-top">
	<a href="javascript:;" class="categoryTop" data-cid="0" data-cname="" data-show='<?php echo empty($this->_var['cat_type_show']) ? '0' : $this->_var['cat_type_show']; ?>' data-seller='<?php echo empty($this->_var['user_id']) ? '0' : $this->_var['user_id']; ?>' data-table='<?php echo empty($this->_var['table']) ? '0' : $this->_var['table']; ?>'><?php echo $this->_var['lang']['reelection']; ?></a>
...
?>
	&gt <a href="javascript:;" class="categoryOne" data-cid="<?php echo $this->_var['navigation']['cat_id']; ?>" data-cname="<?php echo $this->_var['navigation']['cat_name']; ?>" data-url='<?php echo $this->_var['navigation']['url']; ?>' data-show='<?php echo empty($this->_var['cat_type_show']) ? '0' : $this->_var['cat_type_show']; ?>' data-seller='<?php echo empty($this->_var['user_id']) ? '0' : $this->_var['user_id']; ?>' data-table='<?php echo empty($this->_var['table']) ? '0' : $this->_var['table']; ?>'><?php echo $this->_var['navigation']['cat_name']; ?></a>
	<?php endforeach; else: ?>
