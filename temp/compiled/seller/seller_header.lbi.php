<div class="ecsc-head-layout">
	<div class="wrapper">
    	<div class="admin-logo">
        	<a href="./">
                <div class="t">
                    <?php if ($this->_var['seller_logo']): ?>
                    <img src="<?php echo $this->_var['seller_logo']; ?>" class="logo"/>
                    <?php else: ?>
                    <img src="images/logo.png" class="logo"/>
                    <?php endif; ?>
                    <h1><?php echo $this->_var['lang']['seller_center_alt']; ?></h1>
                </div>
        ...
        <div class="ecsc-nav">
        	<ul class="ecsc-nav-ul">
            	<li <?php if (! $this->_var['menu_select']['action']): ?>class="current"<?php endif; ?>><a href="./"><?php echo $this->_var['lang']['00_home']; ?></a><div class="arrow"></div></li>
...
?>
        ...
        <div class="ecsc-admin">
            ...
            <dl>
                ...
                <dd>
                    <span><i class="sc_icon sc_icon_seller"></i><a class="navbar-brand" href="<?php if ($this->_var['head_shop_url']): ?><?php echo $this->_var['head_shop_url']; ?><?php else: ?>../merchants_store.php?merchant_id=<?php echo $this->_var['ru_id']; ?><?php endif; ?>" target="_blank"><?php echo $this->_var['lang']['19_merchants_store']; ?></a></span>
                    <span><i class="sc_icon sc_icon_set"></i><a class="navbar-brand navbar-right" href="index.php?act=clear_cache"><?php echo $this->_var['lang']['clear_cache_alt']; ?></a></span>
                    <span><i class="sc_icon sc_icon_out"></i><a class="navbar-brand navbar-right" href="privilege.php?act=logout"><?php echo $this->_var['lang']['sign_out']; ?></a></span>
                </dd>
            </dl>
        </div>
    </div>
