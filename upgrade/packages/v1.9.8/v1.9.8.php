...
class up_v1_9_8
{
	...
	public function update_database_optionally()
	{
		...
		$sql = 'ALTER TABLE ' . $ecs->table('seller_apply_info') . ' CHANGE `entry_criteria` `entry_criteria` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;';
		$db->query($sql);
	}
