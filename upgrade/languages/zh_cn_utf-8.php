...
$_LANG['lang_description'] = '重点声明';
$_LANG['lang_select'] = '请选择';
...
$_LANG['lang_desc']['desc3'] = '<font class="red">如果您是从大商创 v1.0版本进行升级，并选择大商创接口方式，请先进行会员数据的导入，否则原会员将无法登录。</font>';
$_LANG['ui_title'] = '大商创用户接口';
$_LANG['ui_dsc'] = '大商创方式';
