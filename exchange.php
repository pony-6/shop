...
if ($_REQUEST['act'] == 'load_more_goods') {
	...
	$cart = array('user_id' => $_SESSION['user_id'], 'session_id' => SESS_ID, 'goods_id' => $goods['goods_id'], 'product_id' => $product_info['product_id'], 'goods_sn' => addslashes($goods['goods_sn']), 'goods_name' => addslashes($goods['goods_name']), 'market_price' => $goods['marketPrice'], 'goods_price' => 0, 'goods_number' => $goods_number, 'goods_attr' => addslashes($goods_attr), 'goods_attr_id' => $specs, 'warehouse_id' => $region_id, 'area_id' => $area_id, 'area_city' => $area_city, 'ru_id' => $goods['user_id'], 'is_real' => $goods['is_real'], 'extension_code' => addslashes($goods['extension_code']), 'parent_id' => 0, 'rec_type' => CART_EXCHANGE_GOODS, 'is_gift' => 0);
