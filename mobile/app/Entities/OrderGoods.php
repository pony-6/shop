...
class OrderGoods extends \Illuminate\Database\Eloquent\Model
{
	...
	protected $fillable = array('order_id', 'user_id', 'cart_recid', 'goods_id', 'goods_name', 'goods_sn', 'product_id', 'goods_number', 'market_price', 'goods_price', 'goods_attr', 'send_number', 'is_real', 'extension_code', 'parent_id', 'is_gift', 'model_attr', 'goods_attr_id', 'ru_id', 'shopping_fee', 'warehouse_id', 'area_id', 'is_single', 'freight', 'tid', 'shipping_fee', 'drp_money', 'is_distribution', 'commission_rate', 'stages_qishu');
