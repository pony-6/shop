...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
	...
	{
		$brand_num = dao('brand')->where(array('is_show' => 1))->count();
	...
	public function actionNavList()
	{
		...
		$keyword = input('request.keyword', '', array('html_in', 'trim'));
		...
		if (IS_AJAX) {
			...
			exit(json_encode(array('list' => $list['list'], 'totalPage' => $list['totalpage'])));
		}
