...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
	...
	public function actionIndex()
	{
		...
		if (!empty($users_paypwd)) {
			if ($allow_use_surplus == 1 && $users_paypwd['user_surplus'] == 1 && 0 < $user_info['user_money']) {
	...
	public function actionDone()
	{
		...
		$users_paypwd = dao('users_paypwd')->field('pay_online, pay_password, ec_salt, user_surplus')->where(array('user_id' => $_SESSION['user_id']))->find();
