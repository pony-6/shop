...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
	...
	public function actionDetail()
	{
		...
		$this->assign('best_goods', get_recommend_goods('best', '', $this->region_id, $this->area_info['region_id'], $this->area_city, $goods['user_id'], 1, 'presale'));
		$this->assign('new_goods', get_recommend_goods('new', '', $this->region_id, $this->area_info['region_id'], $this->area_city, $goods['user_id'], 1, 'presale'));
		$this->assign('hot_goods', get_recommend_goods('hot', '', $this->region_id, $this->area_info['region_id'], $this->area_city, $goods['user_id'], 1, 'presale'));
