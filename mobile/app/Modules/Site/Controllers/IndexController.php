...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
	...
	public function actionIndex()
	{
		...
		$this->assign('promotion_goods', limit_grab($this->region_id, $this->area_info['region_id'], $this->area_city));
		...
		$this->assign('best_goods', goods_list('best', $this->page, 4, $this->region_id, $this->area_info['region_id'], $this->area_city));
