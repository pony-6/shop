...
if ($_REQUEST['act'] == 'list') {
	...
	$area = array('region_id' => $region_id, 'province_id' => $province_id, 'city_id' => $city_id, 'district_id' => $district_id, 'goods_id' => $goods_id, 'user_id' => $user_id, 'area_id' => $area_id, 'area_city' => $area_city, 'merchant_id' => $seckill['user_id']);
	$properties = get_goods_properties($goods_id, $region_id, $area_id, $area_city);
	...
	$cart = array('user_id' => $_SESSION['user_id'], 'session_id' => $sess, 'goods_id' => $seckill['goods_id'], 'product_id' => $products['product_id'], 'goods_sn' => addslashes($seckill['goods_sn']), 'goods_name' => addslashes($seckill['goods_name']), 'market_price' => $seckill['market_price'], 'goods_price' => $goods_price, 'goods_number' => $number, 'goods_attr' => addslashes($goods_attr), 'goods_attr_id' => $goods_attr_id, 'ru_id' => $seckill['user_id'], 'warehouse_id' => $region_id, 'area_id' => $area_id, 'is_real' => $seckill['is_real'], 'extension_code' => 'seckill', 'parent_id' => 0, 'rec_type' => CART_SECKILL_GOODS, 'is_shipping' => $seckill['is_shipping'], 'is_gift' => 0);
