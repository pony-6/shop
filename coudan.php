...
if ($_REQUEST['act'] == 'index') {
	...
	$smarty->assign('guess_goods', get_guess_goods($_SESSION['user_id'], 1, 1, 7, $region_id, $area_id, $area_city));
	...
	if (!is_numeric($goods->number) || intval($goods->number) <= 0) {
		...
		if (addto_cart($goods->goods_id, $goods->number, $goods->spec, $goods->parent, $warehouse_id, $area_id, $area_city, -1, 0, '', '', $goods->active_id)) {
